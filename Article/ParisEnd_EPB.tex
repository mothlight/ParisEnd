...
\todo[inline]{Suggestion of more detail about deep learning. Like Zhou et al 2014)}
...
\todo[inline]{Why V2 and not other architectures?}
...
\todo[inline]{Added some more justifications about this method.}
...
\todo[inline]{Suggestion to show Paris sampling locations}
\begin{figure}[!htbp] 
\centering    
\includegraphics[scale=0.60]{Images/Paris-StreetView-SampleLocations_crop.png} 
...
\todo[inline]{Justified random headings}
...
\begin{figure}[!htbp]
\centering 
\includegraphics[scale=0.4]{Images/MelbourneSamples2_crop.png}   
\includegraphics[scale=0.4]{Images/SydneySamples2_crop.png}    
\caption{\bf Evaluation locations for Melbourne (left) and Sydney (right). \todo[inline]{Added sampling locations for Melbourne/Sydney}}    
...
\todo[inline]{Wanted more detail about training accuracy.}
...
\caption{\todo[inline]{New figures for filtered results.}  \bf Predicted similar cities using the GM neural network filtering out probabilities lower than 50\%. Top predicted cities plotted using Fig \ref{fig:colorscheme} colour scheme for Melbourne evaluation locations (top) and Sydney (bottom). Predicted Paris locations marked with black stars.}    
 \label{fig:melmaps2}  
\end{figure} 
...
\caption{\todo[inline]{New figures for filtered results.}  \bf Predicted similar cities using the GS neural network filtering out probabilities lower than 50\%. Top predicted cities plotted using Fig \ref{fig:colorscheme} colour scheme for Melbourne evaluation locations (top) and Sydney (bottom). Predicted Paris locations marked with black stars.}    
 \label{fig:melsat2}  
\end{figure} 
...
\caption{\todo[inline]{New figures for filtered results.}  \bf Predicted similar cities using the GSV-BSV neural network filtering out probabilities lower than 50\%. Top predicted cities plotted using Fig \ref{fig:colorscheme} colour scheme for Melbourne evaluation locations (top) and Sydney (bottom). Predicted Paris locations marked with black stars.}    
...
\todo[inline]{Added 3 paragraphs to discuss street view and future steps.}
...
\todo[inline]{Suggestion to note limitations and implications for urban planning and geography}
